...
namespace fcg{
    ...
    public:
        Sky(const std::string& resourcesDir, const ShaderFiles& celestialFiles, const ShaderFiles& starsFiles) :
           celestialShader(celestialFiles.vertexFile, celestialFiles.fragmentFile),
           starsShader(starsFiles.vertexFile, starsFiles.fragmentFile)
        {
